...
loglevels = {"debug": logging.DEBUG, "error": logging.ERROR, "fatal": logging.FATAL, "info": logging.INFO}
...
# 配置代理
# 请替换'socks5://your_proxy:port'和'your_username', 'your_password'为你的代理信息


updater = Updater(token=config.BOT_TOKEN, use_context=True, request=request)
